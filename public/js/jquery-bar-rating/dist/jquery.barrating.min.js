        ...
        function e() {
            var e = this, n = function () {
                ...
                return e.$elem.find("option").each(function () {
                    var i, a, r, o;
                    i = t(this).val(), i && (a = t(this).text(), r = t(this).data("html"), r && (a = r), o = t("<a />", {
                        href: "#",
                        "data-rating-value": i,
                        "data-rating-text": a,
                ...
                return e.options.deselectable ? e.$elem.find("option:first").val() ? !1 : c() == t.attr("data-rating-value") : !1
            }, y = function (n) {
                ...
                y(t), e.options.hoverState && (x(t), C(t))
            }, M = function (t) {
                t.off(".barrating")
            }, V = function (t) {
                $elements = e.$widget.find("a"), O && O($elements), t ? (M($elements), R($elements)) : S($elements)
            };
            this.show = function () {
                o() || (n(), s(), e.$widget = f(), e.$widget.insertAfter(e.$elem), $(), v(), V(e.options.readonly), e.$elem.hide())
            }, this.readonly = function (t) {
                "boolean" == typeof t && o("readOnly") != t && (V(t), l("readOnly", t), e.$widget.toggleClass("br-readonly"))
            }, this.set = function (t) {
                var n = o("userOptions");
