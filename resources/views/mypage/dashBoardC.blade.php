...
@section('right_content')
    <div class="coupen padding-top-30 padding-bottom-30 margin-bottom-10">
        <span class="h3 text-bold">캠페인 관리</span>
        <p class="padding-top-5">캠페인 목록을 한눈에 살펴 볼 수 있습니다.</p>
    </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="job-tittle03">
                            <h6 class="my_h6 margin-bottom-10 margin-top-20">검수중 캠페인</h6>
                            <div class="panel02 panel-default02">
                                <table class="table_01" width=100% cellpadding=0 cellspacing=0>
                                    ...
                                    @if(count($checking) == 0)
                                        <tr><td colspan="8">검수중 캠페인가 없습니다.</td></tr>
                                    @endif
                        ...
                        <div class="job-tittle03">
                            <h6 class="my_h6 margin-bottom-10 margin-top-20">등록 캠페인</h6>
                            <div class="panel02 panel-default02">
                                <table class="table_01" width=100% cellpadding=0 cellspacing=0>
                                    <col style="width:40%;"/>
                                    <col style="width:15%;"/>
                                    ...
                                    @if(count($registered) == 0)
                                        <tr><td colspan="5">등록된 캠페인가 없습니다.</td></tr>
                                    @endif
                        ...
                        <div class="job-tittle03">
                            <h6 class="my_h6 margin-bottom-10 margin-top-20">진행중 캠페인</h6>
                            <div class="panel02 panel-default02">
                        ...
                        <div class="job-tittle03 margin-bottom-10">
                            <h6 class="my_h6 margin-bottom-10 margin-top-20">완료된 캠페인</h6>
                            <div class="panel02 panel-default02">
                                <table class="table_01" width=100% cellpadding=0 cellspacing=0>
                                    <col style="width:25.6%;"/>
                                    <col style="width:16.6%;"/>
                                    ...
                                    @if(count($done) == 0)
                                        <tr><td colspan="5">완료된 캠페인가 없습니다.</td></tr>
                                    @endif
