                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <div class="job-tittle03">
                            <h6 class="my_h6 margin-bottom-10 margin-top-20">지원한 캠페인</h6>
                        ...
                        <div class="job-tittle03 margin-bottom-10">
                            <h6 class="my_h6 margin-bottom-10 margin-top-20">진행 중인 캠페인</h6>
                            <div class="panel02 panel-default02">
                                <table class="table_01" width=100% cellpadding=0 cellspacing=0>
                                    ...
                                    @if(sizeof($carryon) == 0)
                                        <td colspan="5">진행 중인 캠페인가 없습니다</td>
                                    @endif
                            ...
                            <div class="job-tittle03 margin-bottom-10">
                                <h6 class="my_h6 margin-bottom-10 margin-top-20">완료 캠페인</h6>
                                <div class="panel02 panel-default02">
                                    <table class="table_01" width=100% cellpadding=0 cellspacing=0>
                                        <col style="width:16.6%;"/>
                                        <col style="width:16.6%;"/>
