                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="job-tittle02 txt_color_g">
                            ...
                            @if($loginUser->partners->intro == null)
                                            ...
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption">
                                                    <a href="{{ url('/profile/portfolio/'.$portfolio->id) }}"><h3
                                                                class="thum_title">{{ $portfolio->title }}</h3></a>
                                                    <p class="thum_category">{{ $portfolio->area }}
                                                        > {{ $portfolio->category }}</p>
                                                    <p><a href="{{ url('/profile/portfolio/'.$portfolio->id) }}"
                                                          class="btn btn-primary margin-top-10" role="button">자세히보기</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @if($loginUser->partners->job()->get()->isEmpty())
                                        <tr>
                                            <td colspan="3"><img class="img_cen"
                                                                 src="{{asset('images/empty_area.png')}}"><br>전문분야가 없습니다</td>
                                        </tr>
                                    @endif
