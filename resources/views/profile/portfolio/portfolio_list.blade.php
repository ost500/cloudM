                                ...
                                @foreach($portfolios as $portfolio)
                                    <div class="col-md-4">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                <a href="{{ url('/profile/portfolio/'.$portfolio->id) }}"><h3 class="thum_title"><?php echo mb_strcut($portfolio->title, 0, 37) . ".."; ?> <?=($portfolio->top)?"<span class=\"port_title_box\">대표</span>":"" ?></h3></a>
