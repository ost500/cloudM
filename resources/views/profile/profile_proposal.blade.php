...
@section('right_content')
    ...
    <div id="accordion">
        <div class="job-content job-post-page padding-bottom-30">
            <form action="{{ url('/profile/proposal/save') }}" method="POST" role="form"  id="form"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input class="form-control" type="file"
                               name="proposal_attach" id="proposal_attach"  required="required"
                               value="" />
                        <p class="validation-error">{{ $errors->first('proposal_attach') }}</p>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label"></label>
                    <div class="col-sm-7">
                        <button class="btn btn-sm btn-dark-azure pull-right" type="submit">
                            저장하기
                        </button>
                    </div>
                </div>
