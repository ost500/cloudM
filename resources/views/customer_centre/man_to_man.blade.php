                            ...
                            <div class="job-tittle03 margin-top-20 margin-bottom-40">
                                <div class="row">
                                    <form class="form-horizontal" role="form" method="post"
                                          action="{{ url('/customer/man_to_man') }}">
                                        {!! csrf_field() !!}
                                        <input type="hidden" name="email" value="">

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="title"><span
                                                        class="symbol required"></span> 제목 </label>
                                            <div class="col-sm-9">
                                                <input autofocus class="form-control" name="title" class="title"
                                                       placeholder=""
                                                       required="required">
                                        ...
                                        <div class="form-group padding-top-15">
                                            <label class="col-sm-2 control-label" for="content_query"><span
                                                        class="symbol required"></span> 내용 </label>
                                            <div class="col-sm-9">
