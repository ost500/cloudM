                    ...
                    <div class="col-md-3">
                        <div class="job-sider-bar02">
                            <div class="side-bar-revenues">
                                ...
                                <a href="{{route('agreement')}}" aria-expanded="false" id="second" class="head"><i
                                            class="fa fa-angle-double-right "></i> &nbsp;이용 약관</a>
                                <a href="{{route('personal_info')}}" aria-expanded="false" id="third" class="head"><i
                                            class="fa fa-angle-double-right "></i> &nbsp;개인정보 취급방침</a>


                                <a href="{{url('customer/man_to_man')}}" aria-expanded="false" id="fourth" class="head"><i
                                            class="fa fa-angle-double-right "></i> &nbsp;일대일 문의</a>

                                <a href="{{url('password/reset')}}" aria-expanded="false" id="fifth" class="head"><i
