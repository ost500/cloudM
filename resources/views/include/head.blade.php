...
<head>
    ...
    <script>
        ...
        fbq('init', '1699933600221154');
        fbq('track', "PageView");</script>
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id=1699933600221154&ev=PageView&noscript=1"
        /></noscript>
            ...
            <div class="top-info">
                <div class="container">
                    <ul class="personal-info">
                        ...
                        <li class="notice-li notice-li-txt "><p style="cursor:pointer" id="noti"></p></li>
                        <li class="notice-li">
...
<script>
    ...
    function show_noti() {
        ...
        display_results.html("<div id=\"noti_id_" + index + "\">" + Noti[index] + "</div>");
    }

    $("#noti").click(function () {
        index = index + 1;
        window.location.assign("/customer/notification/" + index);
