                                    ...
                                    <div class="form-group">
                                        <div class="port_guide img_f">
                                            ...
                                            <div class="p_add_span padding-top-0 padding-left-60">
                                                <div class="content">안전한 대금 지급과 프로젝트 진행을 위해서, 가능한 패스트엠 시스템을 이용하여 주시기 바랍니다.<br>기본적으로 대금 지급은 광고주 승인이후에 진행 됩니다.</div>
                                            </div>

                                            <div class="p_add_span">
                                                <p class="title">1. 광고주 지급승인시</p>
                                                <div class="content">광고주가 지급승인시 대행사에게 익일 오후 2시까지, 프로젝트 대금을 지급합니다.</div>
                                                ...
                                                <div class="content">분쟁 방지를 위하여 자료 전달, 업무요청, 답변 등은 프로젝트 게시판을 이용하여 주시기 바랍니다.</div>
                                            </div>
                                        </div>
                                    </div>
