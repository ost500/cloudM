                            ...
                            <div class="job-content job-post-page">
                                ...
                                <div class="panel-group">
                                    <div class="panel panel-default">
                                        ...
                                        <form action="{{ url("/p_add") }}" method="post" role="form" class="smart-wizard" id="form"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label> 광고주소개 </label>
                                                                                <textarea name="company_intro" class="form-control"
                                                                                          rows=10></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-7">
                                                                <fieldset>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group has-success">
                                                                                <label class="control-label"> 총 예산(혹은 월 예산)
...
예시) 참고사이트, 기타 유의사항 등 </textarea>
                                                                    ...
                                                                    <div class="row padding-top-15">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group has-success">
                                                                                ...
                                                                                <input type="date"
                                                                                       class="form-control"
                                                                                       name="deadline"><span id="money"
                                                                                                          class="help-block valid"></span>
                                                                                <span id="companyType-error"
                                                                                               class="help-block valid"
                                                                                               style="display: none;"></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group has-success">
                                                                                ...
                                                                                <span id="money" class="help-block valid"></span>
                                                                                <span id="companyType-error"
                                                                                               class="help-block valid"
                                                                                               style="display: none;"></span>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group has-success">
                                                                                ...
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    <option value="온라인 미팅">온라인 미팅 (카카오톡, skype, 행아웃
                                                                                        등)
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <button type="submit" class="btn btn-1 btn-primary btn-o finish-step btn-wide pull-right">
