			  ...
			  <article>
				...
				<!--<h6 class="my_h6 margin-bottom-20">기본 정보 입력</h6>-->	
					...
					<label>핸드폰번호<span class="set_st">*</span><br/>
						<select name="form_of_phone" class="form-control03 phone_width" id="form_of_business" required="required">
						<option>010</option>
						<option>011</option>
						<option>016</option>
						<option>017</option>
						...
						<input class="form-control03 phone_width" type="text" name="" placeholder="">
						<input class="form-control03 phone_width" type="text" name="" placeholder="">
					</label><br/>	
					<label>회사형태<span class="set_st">*</span>
						<select name="address_sido" class="form-control03 ie-form-control" id="address_sido">
					...
					<textarea name="company_intro" class="form-control04" id="company_intro" rows="4" cols="40" autocomplete="off"></textarea></label><br/>
					...
					<a class="button004 signup003 margin-top-10" href="#.">등록하기</a>	
				</div>
