                                            ...
                                            <div class="signup02">
                                                ...
                                                <div class="margin-bottom-40 job-tittle04 padding-bottom-40">
                                                    <form action="{{ url('p_add/2') }}" method="post" role="form">
                                                        ...
                                                        {{--<label for="e01" class="label_n02"><input name="eee" id="e01"--}}
                                                        {{--type="radio"--}}
                                                        {{--value="e01">아이디어만--}}
                                                        {{--있습니다.</label><br/>--}}
                                                        {{--<label for="e02" class="label_n02"><input name="eee" id="e02"--}}
                                                        {{--type="radio"--}}
                                                        {{--value="e02">필요한 내용들을--}}
                                                        {{--간단히 정리했습니다.</label><br/>--}}
                                                        {{--<label for="e03" class="label_n02"><input name="eee" id="e03"--}}
                                                        {{--type="radio"--}}
                                                        {{--value="e03">상세한 기획 문서가--}}
                                                        {{--존재합니다.</label>--}}
                                                        {{--</label><br/><br/>--}}
                                                        ...
                                                        {{--<label for="m01" class="label_n02"><input name="mmm" id="m01"--}}
                                                        {{--type="radio"--}}
                                                        {{--value="m01">있습니다.</label>--}}
                                                        {{--&nbsp;--}}
                                                        {{--<label for="m02" class="label_n02"><input name="mmm" id="m02"--}}
                                                        {{--type="radio"--}}
