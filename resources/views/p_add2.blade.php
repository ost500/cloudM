			  ...
			  <article>
				...
				<div class="margin-bottom-40 job-tittle04 padding-bottom-40">
					<label for="ca001">카테고리<span class="set_st">*</span><br/>
							<select name="ca001" class="form-control03" id="form_of_birth01">
							<option>카테고리</option>
							<option>키워드</option>
							<option>바이럴</option>
							<option>SNS</option>
					...
					<label>기획상태<span class="set_st">*</span><br/>				
							<label for="e01" class="label_n02"><input name="eee" id="e01" type="radio" value="e01">아이디어만 있습니다.</label><br/>
							<label for="e02" class="label_n02"><input name="eee" id="e02" type="radio" value="e02">필요한 내용들을 간단히 정리했습니다.</label><br/>
							<label for="e03" class="label_n02"><input name="eee" id="e03" type="radio" value="e03">상세한 기획 문서가 존재합니다.</label>
					</label><br/><br/>
					<label>프로젝트 내용<span class="set_st">*</span>
					<textarea name="p_intro" class="form-control05" id="p_intro" rows="4" cols="40" autocomplete="off">
<프로젝트 진행 방식>
...
예) Photoshop, Android, HTML5, Python, Django</span>
				...
				<div class="margin-bottom-59 padding-bottom-30">
					<label for="ca002">모집 마감일자<span class="set_st">*</span><br/>
							<select name="ca002" class="form-control03" id="form_of_birth01">
					...
					<label for="ca003">사전미팅<span class="set_st">*</span><br/>
							<select name="ca003" class="form-control03" id="form_of_birth01">
...
마음에 드는 지원자와의 미팅을 크라우드엠에서 주선해드립니다.</span><br/><br/>
					<label for="ca004">사전 미팅 지역<span class="set_st">*</span><br/>
							<select name="ca004" class="form-control03" id="form_of_birth01">
							<option value="">선택</option><option value="1">서울특별시</option><option value="2">부산광역시</option><option value="3">대구광역시</option><option value="4">인천광역시</option><option value="5">광주광역시</option><option value="6">대전광역시</option><option value="7">울산광역시</option><option value="8">세종특별자치시</option><option value="9">경기도</option><option value="10">강원도</option><option value="11">충청북도</option><option value="12">충청남도</option><option value="13">전라북도</option><option value="14">전라남도</option><option value="15">경상북도</option><option value="16">경상남도</option><option value="17">제주특별자치도</option>
							</select>
					</label><br/>
					...
					<label>프로젝트 매니징 경험<span class="set_st">*</span><br/>				
							<label for="m01" class="label_n02"><input name="mmm" id="m01" type="radio" value="m01">있습니다.</label> &nbsp;
							<label for="m02" class="label_n02"><input name="mmm" id="m02" type="radio" value="m02">없습니다.</label>
					</label>
					<a class="button005 margin-top-10" href="#.">프로젝트 등록하기</a>	
				</div>
